...
const TooltipButton = /*#__PURE__*/forwardRef(({
  a11yText,
  inverted,
  onClick,
  icon: Icon
...
const Footnote = props => {
  ...
  const closeFootnote = useCallback((e, options) => {
    onClose(e, options);
  }, [onClose]);
...
const TermsAndConditions = /*#__PURE__*/forwardRef(({
  copy,
  indexedContent,
  nonIndexedContent,
  ...rest
...
export { A11yContent, Accordion, BenefitNoHeading, BenefitWithHeading, Box, Button, ButtonGroup, ButtonLink, Card, Checkbox, ChevronLink, Col, colours as Colours, DecorativeIcon, DimpleDivider, Disclaimer, DisplayHeading, ExpandCollapse, FeedbackIcon, FlexGrid, Footnote, FootnoteLink, HairlineDivider, Heading, Input, InputFeedback, Link$1 as Link, Login, Notification, OrderedList, Paragraph, PriceLockup, Radio, Responsive, Row, index as SVGs, Select, Spinner, StepTracker, StyledCol, StyledOrderedItem, StyledRow, TermsAndConditions, Text, TextArea, TextButton, Tooltip, media };
