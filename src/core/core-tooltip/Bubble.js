...
import { colorGreyShark, colorWhite } from "../core-colours/colours";
...
const BubbleStyle = styled(({ bubbleDimensions, direction, open, ...rest }) => (
  ...
  ({ bubbleDimensions, direction, open }) => ({
    ...
    ...{
      right:
        direction === "left" ? `-${bubbleDimensions.bubbleOffset}` : undefined,
    },
    ...
    "&:before": {
      ...
      ...{
        right:
          direction === "left"
            ? bubbleDimensions.bubbleTrianglePosition
            : undefined,
      },
      ...{
        left:
