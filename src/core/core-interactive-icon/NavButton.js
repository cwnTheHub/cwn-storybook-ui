...
import { safeRest, uniqueId } from "../../util-helpers";
...
export const StyledInteractiveIconButton = styled(
  SharedStyledInteractiveIconButton
)(animations.scale, animations.reduceMotion);
