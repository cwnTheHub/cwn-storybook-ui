...
const StyledBottomSubNavMenu = styled.a(
  medium,
  helveticaNeueRoman55,
  base,
  ({ variant }) => {
...
const BottomSubNavMenu = forwardRef(
  (
    {
...
BottomSubNavMenu.displayName = "BottomSubNavMenu";

BottomSubNavMenu.propTypes = {
...
export default BottomSubNavMenu;
