...
import { borders, position, forms } from "../../shared-styles";
import {
  colorGreyShuttle,
  colorWhite,
  colorPrimary,
...
import { medium, mediumFont, color } from "../../shared-typography/typography";
...
import FeedbackIcon from "../core-input/FeedbackIcon";
import Box from "../core-box/Box";
import CaretDown from "../core-interactive-icon/svgs/Limited/CaretDown";
...
const StyledSelect = styled.select(
  ...
  ({ withFeedbackIcon }) => ({
    ...
    padding: withFeedbackIcon
      ? "0.5rem 4rem 0.5rem 1rem"
      : "0.5rem 3rem 0.5rem 1rem",
  }),
  {
    "&:focus": {
...
const Select = React.forwardRef(
  (
    ...
    const errorId =
      error && feedback === "error" && fieldId.postfix("error-message");
