...
import { media } from "../../core/core-responsive";
...
export const PrevPaginationContainer = styled(BasePaginationContainer)(
  (props) => ({
    display: !props.showPrevious && "none",
  })
);

export const NextPaginationContainer = styled(BasePaginationContainer)(
  (props) => ({
