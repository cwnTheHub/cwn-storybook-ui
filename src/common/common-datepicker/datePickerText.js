...
const moveFocusByOneWeek =
  "Reculer (vers le haut) et avancer (vers le bas) d'une semaine.";
const moveFocusByOneMonth = "Changer de mois.";
const moveFocustoStartAndEndOfWeek =
  "Aller au premier ou au dernier jour de la semaine.";
const returnFocusToInput = "Revenir au champ de saisie de la date.";
const keyboardForwardNavigationInstructions =
  "Naviguer vers l'avant pour interagir avec le calendrier et sélectionner une date. Appuyer sur la touche Point d'interrogation pour obtenir les raccourcis clavier permettant de modifier les dates.";
const keyboardBackwardNavigationInstructions =
  "Naviguer en arrière pour interagir avec le calendrier et sélectionner une date. Appuyer sur la touche Point d'interrogation pour obtenir les raccourcis clavier permettant de modifier les dates.";
...
const dateIsSelectedAsEndDate = ({ date }) =>
