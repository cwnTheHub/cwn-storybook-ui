...
`import { ButtonGroup } from '@nds_core/nds'`
...
#### Default values
Due to the nature of uncontrolled components, you cannot set an initial checked property on the component. If you need to set a default state for your uncontrolled ButtonGroup, you can use the defaultChecked property on the default ButtonGroup.Item as described in the react documentation.
...
<Story of ={ButtonGroupStories.Secondary} />