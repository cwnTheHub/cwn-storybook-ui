...
import TermsAndConditions from "../../core/core-terms-and-conditions/TermsAndConditions";

export default {
  title: "Core  components/Terms and Conditions/TermsAndConditions",
  component: TermsAndConditions,
};

const Template = (args) => {
  return <TermsAndConditions {...args} />;
};
