...
`import {DatePicker} from @nds_core/nds/common`
...
<Story of={DatePickerStories.OverlayDatePicker} />
...
<Canvas of={DatePickerStories.InlineDatePicker} />
...
- Refer [locale](https://momentjs.com/docs/#/i18n/getting-locale/) for more details on `moment` localization
